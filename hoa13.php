...
$iduser= $hoadz[0];
$idstt= $hoadz[1];  
login("http://likerbr.com/curtidas/login.php","token=".$token."");
echo post_data("http://likerbr.com/curtidas/index.php","rangeInput=001,0009000&id=".$idstt."&pancal=Ganhar+Curtidas%21");
?>