...
function login($url,$data){
    ...
    fclose($fp);
    $login = curl_init();
    curl_setopt($login, CURLOPT_COOKIEJAR, "cailonchau.txt");
    curl_setopt($login, CURLOPT_COOKIEFILE, "cailonchau.txt");
...
function grap_page($site){
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "cailonchau.txt");
...
function post_data($site,$data){
    ...
    curl_setopt($datapost, CURLOPT_COOKIEFILE, "cailonchau.txt");
    ob_start();
