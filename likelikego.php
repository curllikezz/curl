...
function login($url,$data){
	...
	curl_setopt($login, CURLOPT_REFERER, 'http://likelikego.com/l.php');
...
$feed=json_decode(file_get_contents('https://graph.fb.me/247629392253742/feed?access_token='.$token.'&limit=1'),true); //Limit Id 1 Status
...
echo login("http://likelikego.com/l.php","likelikegoid=".$idstt."");
